...
BLYNK_CONNECTED()
{
  ...
  bridge2.setAuthToken("");  // Place Device C AuthToken here so that can access permission to write the values to Device B
  bridge3.setAuthToken("");  // Place Device D AuthToken here so that can access permission to write the values to Device B
}
